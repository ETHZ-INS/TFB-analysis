...
#minRefChr <- c(paste("chr", c(1:22, "X", "Y"),  sep=""))
```
...
missed <- lapply(1:nrow(metaChIP), function(i){
  ...
  # filter ChIP-seq experiments that do not cover 
  # commonChr <- intersect(chIPReDt$chr, minRefChr)
  # if(length(commonChr)<length(minRefChr)){
  #   missing < TRUE
  #   missed <- c(missed, metaChIP$chip_paths[i])
  # }
