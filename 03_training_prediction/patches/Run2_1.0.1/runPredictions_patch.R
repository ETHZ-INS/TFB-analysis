...
# Run with docker image v1.1.0 (TFBlearner)
...
verTfs <- subset(verDt, run_version=="1.0.1" & TFBlearner_version=="0.1.1")$tf
...
for(tf in tfNamesBatch){
  ...
  gc()
  rmarkdown::render("./03_training_prediction/patches/Run2_1.0.1/03.5_patch_prediction.Rmd",
