---
title: "03.5 context-tf-feature construction"
...
if(is.null(tfCofactors) | length(tfCofactors)==0){
  tfFeats <- setdiff(tfFeats, "Cofactor_Binding")
}
...
conTfFeats <- c("Inserts", "Weighted_Inserts", "ChromVAR_Scores")
if(length(trainingContexts)==1){
  conTfFeats <- setdiff(conTfFeats, "ChromVAR_Scores")
}
...
gc()
mae <- saveRDS(mae, file.path(outDir, "06_mae_conTfFeat_sub.rds"))
print(proc.time()-ptm)
gc()
```
