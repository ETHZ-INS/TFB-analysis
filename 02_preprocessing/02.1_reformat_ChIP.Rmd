...
Import metadata:
```{r}
metaData <- readRDS(params$metaDataPath)
...
saveRDS(metaChIP, file.path(outDirMeta, "02_fullMetaChIPAll.rds"))
saveRDS(metaData, file.path(outDirMeta, "02_fullReMetaAll.rds"))
saveRDS(missed, file.path(outDirMeta, "sortedOutChIPs.rds"))
```
